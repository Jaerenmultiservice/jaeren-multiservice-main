...
export default function Smarthus() {
  const navigate = useNavigate();
  return (
    <section className="max-w-4xl mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold mb-4">Smarthus</h1>
      <p className="mb-6">
        Installasjon og konfigurasjon av smarthusløsninger – brytere, sensorer og scener.
      </p>
