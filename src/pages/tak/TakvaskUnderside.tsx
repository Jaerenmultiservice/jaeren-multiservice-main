...
export default function TakvaskUnderside() {
  const navigate = useNavigate();
  return (
    <section className="max-w-4xl mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold mb-4">Takvask</h1>
      <p className="mb-6">
        Takvask med riktig trykk og metode for å fjerne skitt og mose uten å skade taket.
      </p>
