...
export default function Impregnering() {
  const navigate = useNavigate();
  return (
    <section className="max-w-4xl mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold mb-4">Impregnering</h1>
      <p className="mb-6">
        Impregnering av tak for bedre beskyttelse mot fukt, mose og slitasje over tid.
      </p>
      ...
      <ul className="mb-6 list-disc pl-5">
        <li>Takrens før impregnering</li>
      </ul>
      <button
        type="button"
